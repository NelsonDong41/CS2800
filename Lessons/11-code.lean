...
Ungraded, anonymous survey on canvas:
    ...
    - The pace of this class is: (1) too fast, (2) too slow, (3) OK
    - The weekly workload of this class (studying, homeworks, etc) is: (1) too high, (2) too low, (3) OK
    - I am able to solve the homework problems by myself: (1) most of the time, (2) sometimes, (3) almost never

Please answer the survey ASAP!
-/

/- EXAM 1 is coming up soon!
